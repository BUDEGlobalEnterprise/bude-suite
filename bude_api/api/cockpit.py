"""Public API wrappers for `cockpit.py`.

Business logic lives in `bude_api.services.analytics.cockpit`.
...
try:
    ...
    frappe = None
_PUBLIC_NAMES = {'today'}
from ..services.analytics import cockpit as _service
...
@_whitelist()
def today(company: str | None=None):
    return _call("today", company)
