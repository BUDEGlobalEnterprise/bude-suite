"""Public API wrappers for `navigation.py`.

Business logic lives in `bude_api.services.admin.navigation`.
...
try:
    ...
    frappe = None
_PUBLIC_NAMES = {'save'}
from ..services.admin import navigation as _service
...
def save(config_json: str):
    return _call("save", config_json)
