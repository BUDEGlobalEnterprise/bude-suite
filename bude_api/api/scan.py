"""Public API wrappers for `scan.py`.

Business logic lives in `bude_api.services.inventory.scans`.
...
try:
    ...
    frappe = None
_PUBLIC_NAMES = {'resolve_epc'}
from ..services.inventory import scans as _service
...
@_whitelist()
def resolve_epc(epc: str):
    return _call("resolve_epc", epc)
