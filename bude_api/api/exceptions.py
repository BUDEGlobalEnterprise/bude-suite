"""Public API wrappers for `exceptions.py`.

Business logic lives in `bude_api.services.analytics.exceptions`.
...
try:
    ...
    frappe = None
_PUBLIC_NAMES = {'report', 'list_open'}
from ..services.analytics import exceptions as _service
...
@_whitelist()
def report(exception_type: str, item_code: str | None=None, qty=1, warehouse: str | None=None, damage_warehouse: str | None=None, counted_qty=None, barcode: str | None=None, note: str | None=None, allocated_to: str | None=None):
    return _call("report", exception_type, item_code, qty, warehouse, damage_warehouse, counted_qty, barcode, note, allocated_to)

@_whitelist()
def list_open(limit: int=100, offset: int=0):
    return _call("list_open", limit, offset)
