"""Public API wrappers for `companies.py`.

Business logic lives in `bude_api.services.admin.companies`.
...
try:
    ...
    frappe = None
_PUBLIC_NAMES = {'list_companies'}
from ..services.admin import companies as _service
...
def list_companies(limit: int=50):
    return _call("list_companies", limit)
